...
if exist "%RADS_PATH%\Game" (
	...
	if exist "League of Legends.exe" (
		@start "" "League of Legends.exe" "spectator spectator.euw1.lol.pvp.net:8080 0mFn5gLAGzuIEInUVb9V8AHvNRVTxIiT 6793702601 EUW1" "-UseRads" "-Locale=!locale!" "-GameBaseDir=.."
		goto :eof
	)
)
